...
class Cart(models.Model):
    meal  = models.ForeignKey(Meal, related_name = "ordered", on_delete = models.DO_NOTHING )
    quantity = models.IntegerField()
    customer = models.ForeignKey(Customer, related_name = "orderPerItem", on_delete = models.DO_NOTHING)
    order  = models.ForeignKey(Order, related_name = "cart_item", on_delete = models.DO_NOTHING )
    created_at = models.DateTimeField(auto_now_add = True)
    updated_at = models.DateTimeField(auto_now = True)
